...
Bernard Baumohl의 "The Secrets of Economic Indicators" 3판에 기반하여 22개 경제 지표를 데이터베이스화하고, 반도체 섹터에 특화된 투자 시그널을 생성하는 시스템.
...
| 2 | 매크로 환경 | 7 | 25 | 수요/금리/인플레이션 간접 경로 |
| 3 | 보조 확인 | 4 | 6 | 경기 방향성 교차검증 |
| S | 섹터 특화 | 6 | 1+ | 반도체 전용 (SOX, DRAM 가격 등) |
